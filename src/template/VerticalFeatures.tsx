...
const VerticalFeatures = () => (
  <Section
    ...
    <VerticalFeatureRow
      ...
      imageAlt="Skapa DIS"
      icon="/assets/images/icon-idea.svg"
    />
    <VerticalFeatureRow
    ...
    <VerticalFeatureRow
      ...
      imageAlt="Ansöka"
      icon="/assets/images/icon-reward.svg"
    />
    <VerticalFeatureRow
      title="4. Du lägger upp uppgifter direkt i Github/Gitlab"
      description="Nu kan du och dina leverantörer jobba fritt i Github/Gitlab. Varje issue blir en anbudsförfrågan och du och dina leverantörer kommunicerar enkelt via pushnotiser i era mobiler."
      image="/assets/images/github.png"
      imageAlt="Github"
      icon="/assets/images/icon-repo.svg"
      reverse
    />
  </Section>
)
