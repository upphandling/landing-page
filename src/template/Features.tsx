...
const Features = () => (
  <Section>
    <div className="grid grid-cols-1 md:grid-cols-3 gap-x-3 gap-y-8">
      <FeatureElement
        title="Effektivt"
        icon={<img src="/assets/images/thumb-up-dynamic-gradient.png" />}
      >
      ...
      <FeatureElement
        title="Säkert"
        icon={<img src="/assets/images/locker-dynamic-gradient.png" />}
      >
      ...
      <FeatureElement
        ...
        icon={<img src="/assets/images/notebook-dynamic-gradient.png" />}
      >
